...
func (x *IdRequset) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IdRequset) ProtoMessage() {}

func (x *IdRequset) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IdRequset.ProtoReflect.Descriptor instead.
func (*IdRequset) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{4}
}

func (x *IdRequset) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_user_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x31, 0x0a, 0x15, 0x43, 0x68, 0x65, 0x63,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x70, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x27, 0x0a,
	...
	0x72, 0x6f, 0x6c, 0x65, 0x22, 0x4e, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x65, 0x73, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	...
	0x64, 0x61, 0x74, 0x61, 0x32, 0xbc, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2a, 0x0a,
	0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x09, 0x2e, 0x50,
	0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x10, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x65, 0x73, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x2e, 0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74, 0x1a, 0x11, 0x2e, 0x55, 0x73, 0x65,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x3b, 0x0a, 0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50,
	0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64, 0x12, 0x12, 0x2e, 0x50, 0x61, 0x73, 0x73, 0x57, 0x6f,
	0x72, 0x64, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x16, 0x2e, 0x43, 0x68,
...
var file_user_proto_depIdxs = []int32{
	...
	4, // 3: User.GetUserById:input_type -> IdRequset
...
type UserClient interface {
	...
	GetUserById(ctx context.Context, in *IdRequset, opts ...grpc.CallOption) (*UserInfoResponse, error)
...
func (c *userClient) GetUserById(ctx context.Context, in *IdRequset, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
...
type UserServer interface {
	...
	GetUserById(context.Context, *IdRequset) (*UserInfoResponse, error)
...
func (*UnimplementedUserServer) GetUserById(context.Context, *IdRequset) (*UserInfoResponse, error) {
...
func _User_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserById(ctx, req.(*IdRequset))
	}
	return interceptor(ctx, in, info, handler)
}
