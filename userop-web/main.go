...
import (
	...
	"zhaoshop-api/userop-web/initialize"
	"zhaoshop-api/userop-web/utils"
	"zhaoshop-api/userop-web/utils/register/consul"
	validator2 "zhaoshop-api/userop-web/validator"
)
